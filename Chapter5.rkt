...
(member* 'woot '((potato) (chips ((with) fish) (chips))))
...
;  (lambda (l1 l2)
;    (cond
;      ((and (null? l1) (null? l2)) #t) ; could use or... because it one of them is not empty and the other is, you'd need to return false
;      ((and (null? l1) (atom? (car l2))) #f)
;      ((and (null? l1) (list? (car l2))) #f) ; could rewrite as (null? l1) since we know that l2 is not an atom and is not null
;      ((and (atom? (car l1)) (null? l2)) #f)
;      ((and (atom? (car l1)) (atom? (car l2))) (and (eqan? (car l1) (car l2)) (eqlist? (cdr l1) (cdr l2))))
;      ((and (atom? (car l1)) (list? (car l2))) #f)
;      ((and (list? (car l1)) (null? l2)) #f)
;      ((and (list? (car l1)) (atom? l2)) #f)
...
;      ((or (null? l1) (null? l2)) #f) ; we know that if we got to here, they're not null a the same time
;      ((and (atom? (car l1)) (atom? (car l2)))
;       (and (eqan? (car l1) (car l2)) (eqlist? (cdr l1) (cdr l2))))
;      ((or (atom? (car l1)) (atom? (car l2))) #f) ; we know that if we got to here, they're not atoms a the same time
;      (else
